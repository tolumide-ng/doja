...
use crate::nnue::{commons::Align64, network::{L1_CHUNK_PER_32, L1_SIZE}};
...
unsafe fn find_nnz<'a>(input: &Align64<[i32; L1_SIZE / L1_CHUNK_PER_32]>, out: &'a mut Align64<[MaybeUninit<u16>; L1_SIZE / L1_CHUNK_PER_32]>) -> &'a [u16] {
