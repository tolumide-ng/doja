use crate::{bitboard::Bitboard, board::{board_state::BoardState, piece::{self, Piece}}, color::Color, constants::{BISHOP_MOBILITY_ENDGAME, BISHOP_MOBILITY_OPENING, BISHOP_UNIT, CMK_BISHOP_SCORE, CMK_KING_SCORE, CMK_KNIGHT_SCORE, CMK_PAWN_SCORE, CMK_ROOK_SCORE, DOUBLE_PAWN_PENALTY_ENDGAME, DOUBLE_PAWN_PENALTY_OPENING, EVAL_MASKS, ISOLATED_PAWN_PENALTY_ENDGAME, ISOLATED_PAWN_PENALTY_OPENING, KING_SHIELD_BONUS, MATERIAL_SCORE, MIRROR_SCORE, OPENING_PHASE_SCORE, OPEN_FILE_SCORE, PASSED_PAWN_BONUS, PIECE_ATTACKS, PLAYER_PIECES, POSITIONAL_SCORES, QUEEN_MOBILITY_ENDGAME, QUEEN_MOBILITY_OPENING, QUEEN_UNIT, SEMI_OPEN_FILE_SCORE}, game_phase::GamePhase, kogge_stone::KoggeStone, masks::EvaluationMasks, squares::Square};
